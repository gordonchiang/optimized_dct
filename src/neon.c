...
void neon(int input[8][8], int output[8][8]) {
  ...
  int32x4_t prod1, prod2, prod3, prod4;
  ...
  for (i ^= i; !(i&8); i++) {
    ...
    prod1 = vmulq_s32(tempVector, C_row_0);
    prod2 = vmulq_s32(tempVector, C_row_1);
    prod3 = vmulq_s32(tempVector, C_row_2);
    prod4 = vmulq_s32(tempVector, C_row_3);

    pairwiseAddedOnce = vpaddlq_s32(prod1);
    ...
    pairwiseAddedOnce = vpaddlq_s32(prod2);
    narrowed = vmovn_s64(pairwiseAddedOnce);
    pairwiseAddedTwice = vpaddl_s32(narrowed);
    temp[2][i] = (int32_t)vget_lane_s64(pairwiseAddedTwice, 0);

    pairwiseAddedOnce = vpaddlq_s32(prod3);
    narrowed = vmovn_s64(pairwiseAddedOnce);
    pairwiseAddedTwice = vpaddl_s32(narrowed);
    temp[4][i] = (int32_t)vget_lane_s64(pairwiseAddedTwice, 0);

    pairwiseAddedOnce = vpaddlq_s32(prod4);
    narrowed = vmovn_s64(pairwiseAddedOnce);
    pairwiseAddedTwice = vpaddl_s32(narrowed);
    ...
    prod1 = vmulq_s32(tempVector2, C_row_4);
    prod2 = vmulq_s32(tempVector2, C_row_5);
    prod3 = vmulq_s32(tempVector2, C_row_6);
    prod4 = vmulq_s32(tempVector2, C_row_7);
